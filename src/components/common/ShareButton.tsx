...
const ShareButton: React.FC<ShareButtonProps> = ({
  ...
  if (variant === 'button') {
    return (
      <div className={`relative ${className}`} ref={shareMenuRef}>
        <button
          onClick={handleNativeShare}
          className={`flex items-center justify-center ${buttonSizeClasses[size]} bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors`}
        >
        ...
        {showShareMenu && (
          <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
            <div className="p-4">
              <h3 className="text-sm font-medium text-gray-900 mb-3">Share this content</h3>
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                ...
                <button
                  ...
                  className="flex items-center justify-center p-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors"
                >
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <button
      onClick={handleNativeShare}
      className={`${buttonSizeClasses[size]} text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors ${className}`}
      title="Share"
    >
      <Share2 className={sizeClasses[size]} />
    </button>
